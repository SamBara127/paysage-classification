...
def model_test(
    ...
    dataset_test = SceneDataset(samples_test, path_images, transforms)
    ...
    batched_dataset_progress = tqdm(batched_dataset_test, unit=f' Б по {batch_size}')
...
def show_metrics(pred: list[int], true: list[int], labels: dict[int, str]) -> None:
